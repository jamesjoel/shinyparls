...
const Header = () => {
  return (
    <>
        ...
        <div className="infiniteslide_wrap" style={{ overflow: "hidden" }}>
          <div
            ...
            style={{
              ...
              alignItems: "center",
              animation:
                "39.0169s linear 0s infinite normal none running infiniteslide17476492428082376",
            }}
          >
            <div
      ...
      <header
        className="tf-header style-2 header-absolute"
        style={{ top: "unset" }}
      >
              ...
              <div className="col-xl-3 d-none d-xl-block">
                <div className="header-right">
                  ...
                  <div className="tf-languages">
                    <div className="dropdown bootstrap-select tf-dropdown-select style-default type-languages">
                      <div className="dropdown bootstrap-select tf-dropdown-select style-default type-languages">
                  ...
                  <div className="sub-menu mega-menu container-layout-right mega-menu-shop mega-menu-style-2">
                    <div className="mega-menu-wrap">
                      <div className="wrapper-sub-menu">
                        ...
                        <div className="mega-menu-item">
                          <p className="text-caption menu-heading">SHOP LIST</p>
                          <ul className="menu-list">
                            <li>
                              <a
                                href="shop-default.html"
